...
To sum up, this is an approach that incorporates pose estimation information in depth-image-based rendering. The skeletons contributes in detecting disoccluded parts of human figures that have been covered by the background. The introduction of the orientation term in the patch priority guides the inpanting process to complete figures in a more natural way. 
